...
const Nav = () => {
    ...
    const ulBaseClass =  ' sm:static sm:translate-y-0 flex absolute  flex-col px-[4%] bg-gray-800  sm:bg-gray-900 sm:flex-row py-3 sm:flex-grow-[2] flex-1 w-full items-center h-auto justify-between sm:justify-end sm:gap-3 m-0 transition sm:flex'
    const ulClass = isOpen ? ulBaseClass + ' translate-y-[50px]' : ulBaseClass + ' -translate-y-28'
    return (
        <nav className="shadow dark:bg-gray-900" >
            <div className="sm:container flex sm:flex-row flex-col justify-between items-center  relative">
                <div className='flex px-[4%] items-center justify-between w-full dark:bg-gray-900 flex-1 z-10'>
