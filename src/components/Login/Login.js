            ...
            <div className="container">
                <form className='m-auto max-w-[500px] w-5/6 rounded-xl px-8 py-10 dark:bg-gray-800 shadow-card' onChange={onChangeInput} onSubmit={submitForm}>
                    <div className="w-full">
                        ...
                        {wait || redirect ? <span className='dark:text-gray-100 text-gray-900'>{redirect}</span> : <button type="submit"  className='btn btn-primary  p-2 me-2 login-btn'>تسجيل الدخول</button>}
